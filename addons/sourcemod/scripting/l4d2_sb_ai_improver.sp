...
void CreateAndHookConVars()
{
	...
	g_hCvar_ImprovedMelee_Enabled 					= CreateConVar("l4d2_improvedbots_melee_enabled", "1", "是否开启人机近战优化", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hCvar_ImprovedMelee_MaxCount 					= CreateConVar("l4d2_improvedbots_melee_max_team", "1", "允许使用近战的人机数量 <0: 人机不使用近战>", FCVAR_NOTIFY, true, 0.0);
	g_hCvar_ImprovedMelee_SwitchCount 				= CreateConVar("l4d2_improvedbots_melee_switch_count", "3", "附近有多少个感染者时人机切换近战", FCVAR_NOTIFY, true, 1.0);
	...
	g_hCvar_ImprovedMelee_ApproachRange				= CreateConVar("l4d2_improvedbots_melee_approach_range", "0", "Range at which bot's target should be to approach it. <0: Disable Approaching>,default 400", FCVAR_NOTIFY, true, 0.0);
	...
	g_hCvar_ImprovedMelee_ChainsawLimit 			= CreateConVar("l4d2_improvedbots_melee_chainsaw_limit", "0", "The total number of chainsaws allowed on the team. <0: Bots never use chainsaw>,default 1", FCVAR_NOTIFY, true, 0.0);
	...
	g_hCvar_GrenadeThrow_Enabled 					= CreateConVar("l4d2_improvedbots_grenadethrowing_enabled", "0", "Enables survivor bots throwing grenades.,default 1", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	g_hCvar_TankRock_ShootRange 					= CreateConVar("l4d2_improvedbots_shootattankrocks_range", "500", "Range at which rock needs to be for bot to start shooting at it.default 1500", FCVAR_NOTIFY, true, 0.0);
