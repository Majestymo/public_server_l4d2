...
public void OnPluginStart() {
	...
	g_cvRespawnIdle =		CreateConVar("sar_respawn_idle",	"0",		"是否允许闲置玩家自动复活 \n0=否,1=是.", CVAR_FLAGS);
	g_cvRespawnGoAFK =		CreateConVar("sar_respawn_goafk",	"0",		"玩家被复活后是否立即闲置 \n0=否,1=是.", CVAR_FLAGS);
	...
	g_Weapon[0].cvFlags =	CreateConVar("sar_respawn_slot0",	"0",	"主武器给什么 \n0=不给,131071=所有,7=微冲,1560=霰弹,30720=狙击,31=Tier1,32736=Tier2,98304=Tier0.");
	g_Weapon[1].cvFlags =	CreateConVar("sar_respawn_slot1",	"0",		"副武器给什么 \n0=不给,131071=所有.如果选中了近战且该近战在当前地图上未解锁,则会随机给一把.");
	...
	g_Weapon[4].cvFlags =	CreateConVar("sar_respawn_slot4",	"0",		"槽位4给什么 \n0=不给,3=所有.", CVAR_FLAGS);
