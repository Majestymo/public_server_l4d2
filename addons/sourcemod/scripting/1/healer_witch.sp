...
public OnPluginStart()
{
	...
	hw_max_health = CreateConVar("hw_max_health", "100", "获得血量奖励后的最大血量", FCVAR_NONE, true, 100.0);
	hw_cap_health = CreateConVar("hw_cap_health", "1", "Whether to cap the health survivors can gain from this plugin", FCVAR_NONE, true, 0.0, true, 1.0);
	hw_perm_gain = CreateConVar("hw_perm_gain", "10", "回多少实血", FCVAR_NONE, true, 0.0);
	hw_temp_gain = CreateConVar("hw_temp_gain", "10", "回多少实血", FCVAR_NONE, true, 0.0);
}
