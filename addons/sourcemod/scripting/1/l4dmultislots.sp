...
public void OnPluginStart()
{
	...
	g_hSurvivorsLimit	= CreateConVar(			"l4d_multislots_limit_survivors", 				"8", 	"Total survivors allowed on the server. If numbers of survivors reached limit, no any new bots would be created.\nMust be greater then or equal to 'l4d_multislots_max_survivors'", CVAR_FLAGS, true, 4.0, true, 32.0);
	...
	hSpecCheckInterval = CreateConVar(			"l4d_multislots_spec_message_interval", 		"30", 	"Setup time interval the instruction message to spectator.(0=off)", CVAR_FLAGS, true, 0.0);
	...
	if ( g_bLeft4Dead2 ) {
		...
		hSecondWeapon 			= CreateConVar(	"l4d_multislots_secondweapon", 					"0", 	"Second slot weapon for new 5+ Survivor (1 - Dual Pistol, 0=Only Pistol)", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	g_hGiveKitSafeRoom 			= CreateConVar(	"l4d_multislots_saferoom_extra_first_aid", 		"0", 	"If 1, allow extra first aid kits for 5+ players when in start saferoom, One extra kit per player above four. (0=No extra kits)", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	g_hCvar_InvincibleTime 		= CreateConVar(	"l4d_multislots_respawn_invincibletime", 		"0", 	"Invincible time after new 5+ Survivor spawn by this plugin. (0=off)",  FCVAR_NOTIFY, true, 0.0);
