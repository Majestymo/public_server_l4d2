...
public void OnPluginStart()
{
	...
	g_hCvarWitchTimeMin 		= CreateConVar("l4d_witches_spawn_time_min", 	"30.0", 	"Sets the min spawn time for witches spawned by the plugin in seconds", CVAR_FLAGS);
	g_hCvarWitchTimeMax 		= CreateConVar("l4d_witches_spawn_time_max", 	"40.0", 	"Sets the max spawn time for witches spawned by the plugin in seconds", CVAR_FLAGS);
