...
public void OnPluginStart()
{
	...
	g_hInfectedSpawnInterval = CreateConVar("versus_special_respawn_interval", "20.0", "特感刷新间隔", CVAR_FLAG, true, 0.0);
	// 找位设置
	...
	g_hTeleportDist = CreateConVar("inf_teleport_distance", "300", "特感无视野且距离生还者多远将会踢出重新刷新", CVAR_FLAG, true, 0.0);
