...
public OnPluginStart()
{
	...
	g_hConVar_ExecuteResetConVars = CreateConVar("gamemode_resetconvars", "0", "Resets the console vars () before executing the config", CVAR_FLAGS, true, 0.0, true, 1.0);
	g_hConVar_ConfigCoop = CreateConVar("gamemode_config_coop", "server_coop.cfg", "CFG file to execute when game mode is coop.", CVAR_FLAGS);
	g_hConVar_ConfigVersus = CreateConVar("gamemode_config_versus", "server_versus.cfg", "CFG file to execute when game mode is versus.", CVAR_FLAGS);
	g_hConVar_ConfigTeamVersus = CreateConVar("gamemode_config_teamversus", "server_teamversus.cfg", "CFG file to execute when game mode is teamversus.", CVAR_FLAGS);
	g_hConVar_ConfigSurvival = CreateConVar("gamemode_config_survival", "server_survival.cfg", "CFG file to execute when game mode is survival.", CVAR_FLAGS);
	g_hConVar_ConfigRealism = CreateConVar("gamemode_config_realism", "server_realism.cfg", "CFG file to execute when game mode is realism.", CVAR_FLAGS);
	g_hConVar_ConfigScavenge = CreateConVar("gamemode_config_scavenge", "server_scavenge.cfg", "CFG file to execute when game mode is scavenge.", CVAR_FLAGS);
	g_hConVar_ConfigTeamScavenge = CreateConVar("gamemode_config_teamscavenge", "server_teamscavenge.cfg", "CFG file to execute when game mode is teamscavenge.", CVAR_FLAGS);
	
	g_hConVar_ConfigCoop_Easy = CreateConVar("gamemode_config_coop_easy", "server_coop_easy.cfg", "CFG file to execute when game mode is coop and the difficulty is Easy.", CVAR_FLAGS);
	g_hConVar_ConfigCoop_Normal = CreateConVar("gamemode_config_coop_normal", "server_coop_normal.cfg", "CFG file to execute when game mode is coop and the difficulty is Normal.", CVAR_FLAGS);
	g_hConVar_ConfigCoop_Hard = CreateConVar("gamemode_config_coop_hard", "server_coop_hard.cfg", "CFG file to execute when game mode is coop and the difficulty is Advanced.", CVAR_FLAGS);
	g_hConVar_ConfigCoop_Impossible = CreateConVar("gamemode_config_coop_impossible", "server_coop_impossible.cfg", "CFG file to execute when game mode is coop and the difficulty is Expert.", CVAR_FLAGS);
