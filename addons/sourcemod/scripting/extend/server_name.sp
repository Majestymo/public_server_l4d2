...
{
	HostName = CreateKeyValues("StarHappy");
	...
	cvarMainName = CreateConVar("sn_main_name", "Star Happy");
	g_hHostNameFormat = CreateConVar("sn_hostname_format", "{hostname}{gamemode}");
	cvarServerNameFormatCase1 = CreateConVar("sn_hostname_format1", "{StarHappy}{Full}{MOD}{Confogl}");
